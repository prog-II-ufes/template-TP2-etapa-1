...
/**
 * Função que recebe uma fila, um dado genérico e suas funções de callback para criar um Documento
...
/**
 * Função que executa a impressão de todos os documentos da fila.
 * A impressão é feita em duas etapas. Primeiro Documento é impresso na tela e depois em arquivo.
 * A função também recebe o path para o diretóio onde o arquivo deve ser criado ou editado
 */
